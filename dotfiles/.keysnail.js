...
key.setGlobalKey([['C-M-l'], ['M-o']], function (ev) {
    getBrowser().mTabContainer.advanceSelectedTab(1, true);
}, 'Select next tab');

key.setGlobalKey([['C-M-h'], ['M-O']], function (ev) {
    getBrowser().mTabContainer.advanceSelectedTab(-1, true);
}, 'Select previous tab');
...
key.setEditKey('M-_', function (ev) {
...
key.setEditKey([['M-f'], ['C-M-f']], function (ev) {
    command.forwardWord(ev);
}, 'Next word');

key.setEditKey([['M-b'], ['C-M-b']], function (ev) {
